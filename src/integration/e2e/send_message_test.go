...
//}
//
//func (g *Tester) selectServer() gatewayhttp.SelectServerResponse {
...
//}
//
//func (g *Tester) sendMessage(recipientID pkgid.ID, message string) gatewayhttp.SelectServerResponse {
